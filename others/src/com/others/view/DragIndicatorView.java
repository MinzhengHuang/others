...
import com.others.R;
import com.others.data.Point;
import com.others.data.PointEvaluator;
...
public class DragIndicatorView extends TextView {
    ...
    private final class SpringView extends View {
        ...
        public void startSpringAction() {
            ...
            mSpringAnimation = ValueAnimator.ofObject(new PointEvaluator(),new Point(cur_x, cur_y), new Point(from_x, from_y));
