...
public class HorizontalActivity extends Activity implements OnClickListener {
    ...
    private void addItem() {
        View v = LayoutInflater.from(this).inflate(R.layout.item_underline_horizontal, mUnderLineLinearLayout, false);
