...
/**
 * Created by huangminzheng on 16/4/28.
 */
...
import com.others.R;
import com.others.utils.Utils;
import com.others.view.UnderLineLinearLayout;


public class UnderLineActivity extends Activity implements OnClickListener{
    ...
    private void addItem() {
        View v = LayoutInflater.from(this).inflate(R.layout.item_underline_vertical, mUnderLineLinearLayout, false);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.add_marginside:
                int curMargin= Utils.px2dp(this, mUnderLineLinearLayout.getLineMarginSide());
                mUnderLineLinearLayout.setLineMarginSide(Utils.dp2px(this, ++curMargin));
                mCurMargin.setText("current line marginside = "+curMargin+"dp");
                break;
            case R.id.sub_marginside:
                int curMargin2=Utils.px2dp(this, mUnderLineLinearLayout.getLineMarginSide());
                mUnderLineLinearLayout.setLineMarginSide(Utils.dp2px(this,--curMargin2));
