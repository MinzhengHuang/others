package com.others.countdowntimer;
...
public class CountDownTimerActivity extends Activity implements View.OnClickListener{
    ...
    private class MyCountDownLisener implements CountDownTimerService.CountDownTimerListener {
